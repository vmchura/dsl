...
import shared.models.ActionBySmurf.{ActionBySmurf, CorrelatedParallelDefined, SmurfsEmpty}
...
class ParseReplayFileServiceEmptyImpl extends ParseReplayFileService {
  ...
  def parseFileAndBuildAction(file: File, discordUserID1: String, discordUserID2: String): Future[Either[String,ActionByReplay]] =
    Future.successful(Right(ActionByReplay(defined = true,Some("Flash"),Some("Bisu"),CorrelatedParallelDefined,1,"LostTemple")))
}
