...
case class MatchDiscord(matchPK: MatchPK,tournamentName: String, round: String, firstChaNameID: Long,
                        secondChaNameID: Long, userSmurf1: UserSmurf, userSmurf2: UserSmurf, complete: Boolean,
  ...
  def convertToMatch(): Match = Match(matchPK,tournamentName, firstChaNameID, secondChaNameID, round,
    Some(userSmurf1.discordUser.userName), Some(userSmurf2.discordUser.userName),complete=complete, replaysAttached)
